...
class CsvUtilsTest {
    ...
    void givenValidCsv_whenReadCsvFromResource_thenReturnsRecordList() {
        ...
        assertThat(result.get(0)).containsExactly("Dell", "USA", "1984", "https://www.dell.com", "Dell is a global leader in personal computing and enterprise solutions, known for reliable laptops and desktops.");
